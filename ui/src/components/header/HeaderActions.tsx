  ...
  return (
    <>
      ...
      <button
        ...
        data-tooltip={allCollapsed ? "Expand all files" : "Collapse all files"}
      >
        {allCollapsed ? (
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <button
        ...
        data-tooltip={contextCount ? `Context (${contextCount} files)` : "Context"}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="18"
      ...
      {submitOpen && (
        <SubmitPanel
          ...
          onSubmit={(mode, comment, selectedGroups) => {
            onAction(mode, comment, selectedGroups);
            setSubmitOpen(false);
          }}
