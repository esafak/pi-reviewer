  ...
  return (
    <>
      <button
        ...
        data-tooltip={sidebarOpen ? "Hide file sidebar" : "Show file sidebar"}
      >
        <svg
      ...
      >
        ...
        {reviewedByLabel && (
          <span
            className="meta-chip reviewed-by"
            data-tooltip={[currentModel, currentThinking].filter(Boolean).join(" · ")}
          >
            {reviewedByLabel}
          </span>
        )}
