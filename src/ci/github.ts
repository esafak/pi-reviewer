...
export class GitHubClient {
  ...
  updateReviewComment(repo: string, number: number, comment: number, body: string) { return this.request<ReviewComment>(`/repos/${repo}/pulls/comments/${comment}`, { method: "PATCH", body: JSON.stringify({ body }) }); }
